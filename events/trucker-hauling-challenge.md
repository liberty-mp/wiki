...
- Jucătorii vor dropa un crate când vor acumula <Dinero :amount="525" /> - <Dinero :amount="825" /> în urma activităţii in cadrul jobului.

### Reward

Pe parcursul evenimentului vei primi un <InventoryItem itemKey="crate_trucker_event" width="64" :qt="1" />
