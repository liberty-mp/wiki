...
::: tip
`Hooked Rope` pot fi folosite la [ATM Robbing](./robberies/atm-robbery.md) iar C4 Bomb poate fi folosit pentru [Fleeca Bank Rob](./robberies/fleeca-bank-robbery.md).
:::
